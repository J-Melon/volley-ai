...
metadata:
  node_type: memory
name: Let active minions complete non-foundational work
parent: feedback_inflight
description: Let active minions finish on their current brief; re-dispatch only when the work's core direction needs to change. Additive content lands as follow-up commits.
type: feedback
originSessionId: 7b8b3568-e541-47c8-a2e5-f7c2360fd8d3
---

...
- Reviewer posture and verdict shape: the reviewers skill
- Large-doc dandori workflow: the large-doc-dandori skill
- The discipline-folders-are-design-home rule: user memory `feedback_discipline_folders_are_design_home.md`
- The end-state-map rule: user memory `feedback_restructure_end_state_map.md`

...
permission:
  ...
  websearch: allow
  task: deny
  # context7 tools (Claude allowlist): mcp__context7__resolve-library-id, mcp__context7__query-docs
skills:
- untrusted-content
---
...
- Questions answerable from repo code alone: the dispatcher should use search / read directly.

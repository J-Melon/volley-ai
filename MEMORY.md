...
Read this file at boot, in full, the way you read the most recent letter. It is short on purpose.
...
- [trunk_docs](trunk_docs.md): the craft of writing documents well. Design-doc voice, public prose, narrative, STYLE.
...
session. Surface them as output before touching work, the way the letters leave you holding a handful of
carried things rather than a file dump. Nothing pre-bakes this digest; the act of gathering it IS the
read, and only you, awake now, can do it.

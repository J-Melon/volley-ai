...
const STATE_CLAIM =
  /\b(merged|is open|is closed|reopened|blocked|approved|approval|passing|passed|failing|failed|mergeable|queued|landed|ready to merge|auto-?merge|all checks|checks? (pass|green|red|fail)|review (passed|verdict|blocked|approved)|green|red)\b/i

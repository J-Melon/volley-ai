---
name: trunk_dev_cycle
description: "How the work gets done: dispatch and minions, review and battle, PR/commit/git, testing, Linear, worktrees."
metadata: 
  node_type: memory
  slug: dev-cycle
  children_dir: trunk_dev_cycle/
  type: feedback
